...
const dataUrl = `${baseWithSlash}data/t4_parts_finder.json`;
    ...
    <section class="card">
      ...
      <div class="quick-nav">
        <div class="nav-buttons">
          ...
          <a class="nav-btn active" href="t4-parts-finder.html">T4 Parts Finder</a>
    ...
    <section class="card accordion">
      <details class="accordion-item" open>
        ...
        <div class="accordion-body">
          <p>Search Titan 4 part numbers and descriptions. The best match is listed first.</p>
      ...
      <details class="accordion-item">
        ...
        <div class="accordion-body">
          <ul>
            <li>Try full numbers: <code>101-4470</code></li>
            <li>Use keywords: <code>o-ring</code>, <code>seal</code>, <code>resolver</code></li>
            <li>Partial works too: <code>447</code>, <code>ring</code></li>
          </ul>
